...
if($update)
{
    echo "<script type='text/javascript'>alert('Profile Updated Succesfully');window.location.href='logout.php';</script>";
}
else
{
    echo "<script type='text/javascript'>alert('Failed To Update Profile');window.location.href='userprofile.php';</script>";
}
