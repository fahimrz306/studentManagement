            ...
            <div class="content_area">
                <div class="userprofile">
                    <table align="center" border="1px solid #4caf50"  style="width:500px;  line-height:30px;">
                        <tr>
                            <th colspan="2"><h1 style="margin-left:27%;"><i class="bi bi-search"></i><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                            <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                            </svg> Search Student</h1></th>
                        </tr>
                        <form id="search-form" action="searchstudentconnect.php" method="post" enctype="multipart/form-data">
                        <tr>
                            <td>Choose Class</td>
                            <td style="color:white; font-size:35px;"><div style="border: none;color:white; font-size:35px;" class="text-box">
                            <input type="text" name="class" id="class" required="required" placeholder="Please Enter Class" autofocus/><br />
                            </div></td>
                        </tr>
                        <tr>
                            <td>Roll Number</td>
                            <td><div style="border: none; color:white;font-size:35px;"class="text-box" ><input type="text" name="roll" id="roll" required="required" placeholder="Please Enter Roll"/><br/></div></td>
                        </tr>
                        <tr colspan="2" height="20px">
                            <td colspan="2"><input class="btn" style="background-color: #F53121; color: white;border: 2px solid #F53121;box-shadow: 2px 2px black; border-radius:15px; font-weight: bolder;width:100px; margin:20px; margin-left:190px;" type="submit" value=" Submit " name="submit"/><br /></td>
                        </tr>
                        </form>
                    </table>
                </div> 
