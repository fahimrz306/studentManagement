...
<div class="mainContainer">
    <div class="signup-box" style="transform: translate(-50%,10%);">
        <h1 style="transform: translate(-15%,0%);font-size: 30px; Margin-top:30px;color:white;font-size: 30px; Margin-top:30px;">Edit Information</h1>

        <form id="edit" action="Updateuser.php" method="POST" enctype="multipart/form-data">

            <span style="margin:none; margin-left:70px; padding:5px;"> <?php echo "<img style='height:100px;width:100px;' src='image/".$row['photo']."'>";?></span><br><p></p>
