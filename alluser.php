		...
		<div class="mainContainer">
				...
				<table align="center" border="1px" style="width:700px; line-height:30px;">
					...
					?>
                        <tr>
                            ...
                            <td> <span style="margin:5px; padding:5px;" href="#"> <?php echo "<img style='height:60px;width:60px;' src='image/".$rows['photo']."'>";?></span></td>
                            
                            <td><a href=<?php echo"edituser.php?id=$rows[id]&name=$rows[name]&username=$rows[username]&email=$rows[email]&photo=$rows[photo]"?> style="margin:5px; padding:5px;"><i class="bi bi-pencil-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                            </svg></a></td>

                            <td><a href=<?php echo "deleteuser.php?id=$rows[id]"?> style="margin-left:5px; padding:5px;"><i class="bi bi-trash-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
            ...
            <div style="text-decoration:none; margin-left:300px; ">
                ...
                <?php
                        ...
                        $a=$count/5; //how many page
                        $a=ceil($a);

                        for($b=1;$b<=$a;$b++)
                        {
                            ?>
                            <a href="alluser.php?page=<?php echo $b;?>" >
                            <?php echo $b.""; ?>
                    <?php
                        }
                    ?>
