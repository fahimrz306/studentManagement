...
<body>
    ...
    <!--main container/wrapper start from here-->
		<div class="mainContainer">
			...
			<!-- content_area start from  here-->
			<div class="content_area">


				<table align="center" border="1px" style="width:700px; line-height:30px;">
					<tr>
						<th colspan="9"><div class="addstudent" style="margin-left: 22%;"><h1><i class="bi bi-people-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
						<path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
						<path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z"/>
						<path d="M4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z"/>
						</svg> All Students<h1><div></th>
					</tr>
					<tr>
						<th><i class="bi bi-list-ol"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-ol" viewBox="0 0 16 16">
						...
						<th><i class="bi bi-person-lines-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
  						<path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
						</svg>  Contact</th>

						<th><i class="bi bi-image"></i><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-image" viewBox="0 0 16 16">
					...
					$query="Select * from student_info limit $page1,5";
					...
					?>
                        <tr>
                            ...
                            <td> <span style="margin:5px; padding:5px;" > <?php echo "<img style='height:60px;width:60px;' src='image/".$rows['photo']."'=>";?></span></td>
                            
                            <td><a href=<?php echo"editstudent.php?id=$rows[id]&name=$rows[name]&roll=$rows[roll]&class=$rows[class]&city=$rows[city]&contact=$rows[contact]&photo=$rows[photo]"?> style="margin:auto;margin-left:10px; padding:auto;" ><i class="bi bi-pencil-square"></i><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                            <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                            <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                            </svg></a></td>
							
							
                            <td><a href=<?php echo"deletestudent.php?id=$rows[id]"?> style="margin:auto; margin-left:10px; padding:auto;"><i class="bi bi-trash-fill"></i><svg xmlns="http://www.w3.org/2000/svg" width="50px" height="30px" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
            ...
            <div style="text-decoration:none; margin-left:300px; ">
                ...
                <?php
                        ...
                        {
                            ?>
                            <a href="allstudent.php?page=<?php echo $b;?>" >
                            <?php echo $b.""; ?>
                    <?php
                        }
                    ?>
